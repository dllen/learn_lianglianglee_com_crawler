...
Source: https://learn.lianglianglee.com/专栏/容器实战高手课/10 Swap：容器可以使用Swap空间吗？.md
...
因为mem\_alloc申请12GB内存已经和节点最大内存差不多了，我们如果查看 `cat /proc/zoneinfo` ，也可以看到normal zone里high （water mark）的值和free的值差不多，这样在free
