...
Source: https://learn.lianglianglee.com/专栏/容器实战高手课/加餐02 理解perf：怎么用perf聚焦热点函数？.md
...
![img](assets/7f66d31a3e32f8bcfc8600abe713962e.png)
...
第二点，需要允许容器在没有SYS\_ADMIN这个capability（Linux capability我们在[第19讲]说过）的情况下，也可以让perf访问这些event。那么现在我们需要做的就是，在宿主机上设置出 `echo -1 > /proc/sys/kernel/perf_event_paranoid`，这样普通的容器里也能执行perf了。
