...
Source: https://learn.lianglianglee.com/专栏/容器实战高手课/02 理解进程（1）：为什么我在容器中不能kill 1号进程？.md
...
![sig_task_ignored](assets/cec445b6af1c0f678cc1b538bb03d67f.jpeg)
...
我们可以看出来，其实**最关键的一点就是 handler == SIG\_DFL 。Linux内核针对每个Nnamespace里的init进程，把只有default handler的信号都给忽略了。**
