...
Source: https://learn.lianglianglee.com/专栏/全解网络协议/19 我老了，让我儿子来吧 - HTTP2.md
...
* 流量控制窗口大小通过WINDOW\_UPDATE 帧更新，这个字段指定了流ID和窗口大小递增值。
...
HTTP 2.0标准没有规定任何特定的算法、值，或者什么时候发送WINDOW\_UPDATE帧。因此，实现可以选择自己的算法以匹配自己的应用场景，从而求得最佳性能。
