...
Source: https://learn.lianglianglee.com/专栏/Flutter核心技术与实战/42 如何构建高效的Flutter App打包发布环境？.md
...
如果你不希望将发布证书、私钥暴露给Travis，也可以把未签名的ipa包下载下来，解压后通过codesign命令，分别对App.Framework、Flutter.Framework以及Runner进行重签名操作，然后重新压缩成ipa包即可。[这篇文章](https://www.yangshebing.com/2018/01/06/iOS逆向必备绝技之ipa重签名/)介绍了详细的操作步骤，这里我们也不再赘述了。
