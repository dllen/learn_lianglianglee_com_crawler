...
Source: https://learn.lianglianglee.com/专栏/左耳听风/081  程序员练级攻略（2018）：分布式架构入门.md
...
* 容错的上限 - 由 [DLS 论文](http://groups.csail.mit.edu/tds/papers/Lynch/jacm88.pdf) ，我们可以得到以下结论。
  ...
  + 在异步（asynchronous）的网络环境中，具有确定性质的协议无法容忍任何错误，但这篇论文并没有提及 [randomized algorithms](http://link.springer.com/chapter/10.1007/978-3-540-77444-0_7)，在这种情况下可以容忍最多 1⁄3 的拜占庭故障。
