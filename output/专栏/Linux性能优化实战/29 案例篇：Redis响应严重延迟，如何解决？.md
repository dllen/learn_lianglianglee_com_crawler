...
Source: https://learn.lianglianglee.com/专栏/Linux性能优化实战/29 案例篇：Redis响应严重延迟，如何解决？.md
...
* /get\_cache/：查询指定值的缓存数据，并返回处理时间。其中，type\_name 参数只支持 good, bad 和 normal（也就是找出具有相同 value 的 key 列表）。
