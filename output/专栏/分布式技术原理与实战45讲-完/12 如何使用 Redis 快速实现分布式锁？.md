...
Source: https://learn.lianglianglee.com/专栏/分布式技术原理与实战45讲-完/12 如何使用 Redis 快速实现分布式锁？.md
...
* **超时释放**，超时释放是锁的另一个必备特性，可以对比 MySQL InnoDB 引擎中的 innodb\_lock\_wait\_timeout 配置，通过超时释放，防止不必要的线程等待和资源浪费；
