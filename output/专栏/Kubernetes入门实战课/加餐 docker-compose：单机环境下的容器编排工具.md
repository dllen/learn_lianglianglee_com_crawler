...
Source: https://learn.lianglianglee.com/专栏/Kubernetes入门实战课/加餐 docker-compose：单机环境下的容器编排工具.md
...
![图片](assets/ecb1194e994c0a127d4818310dac14ab.png "图片来自网络")
...
docker-compose的安装非常简单，它在GitHub（<https://github.com/docker/compose>）上提供了多种形式的二进制可执行文件，支持Windows、macOS、Linux等操作系统，也支持x86\_64、arm64等硬件架构，可以直接下载。
