...
Source: https://learn.lianglianglee.com/专栏/iOS开发高手课/31 iOS 开发学习资料和书单推荐.md
...
Raywenderlich 和 objc.io 的书基本都是 Swift 来写的。如果你想更深入地理解 Objective-C 的话，我推荐[《Objective-C高级编程》](time://mall?url=https://h5.youzan.com/v2/goods/2ok8btknjr3e0?step=1)这本书。这本书里的知识点并不多，主要讲的是内存管理、Block、GCD（Grand Central Dispatch）。
...
如果你想要了解系统工作原理的话，我推荐阅读[《程序员的自我修养 - 链接、装载与库》](time://mall?url=https://h5.youzan.com/v2/goods/3f42f8o0371ug?step=1)。这本书详细且深入地讲解了硬件、操作系统、线程的知识。
...
当你有了大量的编程经验，需要考虑工程架构合理性的时候，我推荐你看看[《架构整洁之道》](time://mall?url=https://h5.youzan.com/v2/goods/276fjn6r89uuw?step=1)这本书。架构设计的思想也不会过时，并适用于所有的知识领域。
...
如果你还想阅读更多计算机编程相关的经典书，可以再看看《编码》、[《代码整洁之道》](time://mall?url=https://h5.youzan.com/v2/goods/3691yho9a34oo?step=1)、《代码大全》、[《算法》](time://mall?url=https://h5.youzan.com/v2/goods/3f1l7krpotnjc?step=1)。
