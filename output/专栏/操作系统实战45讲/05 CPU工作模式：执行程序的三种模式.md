...
Source: https://learn.lianglianglee.com/专栏/操作系统实战45讲/05 CPU工作模式：执行程序的三种模式.md
...
![](assets/82f4dd5a549f417c8f9e7be46ebae2ee.jpg)
...
![](assets/c00da4c7d506403cb12c3b68782657f9.jpg)
...
![](assets/6885d1d0b8814bdf9252f5f2eaad532f.jpg)
...
![](assets/9e0c6ffc5f5b4f63a1a80a44484cf633.jpg)
...
![](assets/99ee907a771e44b28de32884f45a7730.jpg)
...
![](assets/6d7c238cded44bec874c6c160bf3fa84.jpg)
...
![](assets/9e9a52ef07e64a40927735dddf2f367e.jpg)
...
![](assets/edb845fa5abb442fb8fca901a92c9e3e.jpg)
...
![](assets/6d465b27443a4c41ab2d7a72055fc8b2.jpg)

同样的，保护模式要实现中断，也必须在内存中有一个中断向量表，同样是由IDTR寄存器指向，只不过中断向量表中的条目变成了中断门描述符，如下图所示。

![](assets/deba21f80d9d4498b06e1d4eca6f8089.jpg)
...
![](assets/547e5cdc1fea40aba6fb83b4ddecd39b.jpg)
...
![](assets/06c851aa63a7455981e487a1d16fe483.jpg)
...
![](assets/cc2dfef67fda4940b7a85771130f234c.jpg)
...
1. 开启长模式，要同时开启保护模式和分页模式，在实现长模式时定义了MSR寄存器，需要用专用的指令rdmsr、wrmsr进行读写，IA32\_EFER寄存器的地址为0xC0000080，它的第8位决定了是否开启长模式。
