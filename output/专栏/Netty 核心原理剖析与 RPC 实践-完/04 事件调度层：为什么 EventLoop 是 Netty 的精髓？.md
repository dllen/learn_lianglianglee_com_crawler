...
Source: https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/04 事件调度层：为什么 EventLoop 是 Netty 的精髓？.md
...
![1.png](assets/Ciqc1F-ZNCCANWF0AAG4qWOzD48243.png)
...
![2.png](assets/Ciqc1F-ZNCyAeFxmAAH_Xaxv5gc975.png)
（[摘自 Lea D. Scalable IO in Java](http://gee.cs.oswego.edu/dl/cpjslides/nio.pdf])）
...
![3.png](assets/CgqCHl-ZNDiAPgGOAAHx74H-t44265.png)
（[摘自 Lea D. Scalable IO in Java](http://gee.cs.oswego.edu/dl/cpjslides/nio.pdf])）
