...
Source: https://learn.lianglianglee.com/专栏/Web漏洞挖掘实战/15 自动化注入神器（二）：sqlmap的设计架构解析.md
...
![图片](assets/4f218fe3d84042dd98c3be808a8b8883.jpg)
...
这个值是用“2\_M/T”这个表达式计算出来的，要想得出结果，我们需要获得变量M和T的值。其中M为a和b相同部分的长度，在这个例子中，因为`a`和`b`相同部分为`ab`，所以M的 值就是2。T则是a和b的长度之和，所以T的值为9。因此，计算结果为“2\_2⁄9=0.4444…”。
...
![图片](assets/35691742b375484ca57a306f61945dd5.jpg)
...
![图片](assets/86a28e16414a428793eab3ed3c52bc70.jpg)
