...
Source: https://learn.lianglianglee.com/专栏/从 0 开始学架构/33 传统的可扩展架构模式：分层架构和SOA.md
...
![图片来自网络](assets/acae5ee24fd6e6c41edb193a88e32f55.jpg)

1. MVC架构、MVP架构

划分的对象是单个业务子系统，划分的维度是职责，将不同的职责划分到独立层，但各层的依赖关系比较灵活。例如，MVC架构中各层之间是两两交互的：

![img](assets/3602b5bb371ebyy597c2d6b68f83d150.jpg)
...
![img](assets/15712073102390bede89e54ce6f2d13a.jpg?wh=3800*3700)

典型的J2EE系统架构也是逻辑分层架构，架构图如下：

![img](assets/3296df5420c88834493a6239d8dc62cb.jpg)

针对整个业务系统进行逻辑分层的架构图如下：

![img](assets/dfd57e17b23823926d427db57620a0e4.jpg)
...
![img](assets/f3df4b47a3fbb3e1975a5f9ae61c1477.jpg?wh=3037*2496)
...
![img](assets/b2d9b4b5a978dd0f7ef4d4502dec5821.jpg?wh=3773*2762)
...
![img](assets/40f125000a4f9fda00d612a2b3171740.jpg?wh=2961*2242)
...
![img](assets/fa9e178249d261b1e29850f3c9dc2684.jpg)

下图中ESB将REST协议转换为RMI和AMQP两个不同的协议：

![img](assets/b04b7a89e8e859d84c70e55aa05372c8.jpg?wh=3332*1435)
