...
Source: https://learn.lianglianglee.com/专栏/MySQL实战宝典/03  日期类型：TIMESTAMP 可能是巨坑.md
...
通过字段 last\_modify\_date 定义的 ON UPDATE CURRENT\_TIMESTAMP(6)，那么每次这条记录，则都会自动更新 last\_modify\_date 为当前时间。
