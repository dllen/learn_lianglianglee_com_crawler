...
Source: https://learn.lianglianglee.com/专栏/Kafka核心源码解读/00 导读 构建Kafka工程和源码阅读环境、Scala语言热身.md
...
在漫长的等待之后，你的路径上会新增一个名为kafka的子目录，它就是Kafka项目的根目录。如果在你的环境中，上面这条命令无法执行的话，你可以在浏览器中输入<https://codeload.github.com/apache/kafka/zip/trunk>下载源码ZIP包并解压，只是这样你就失去了Git管理，你要手动链接到远程仓库，具体方法可以参考这篇[Git文档](https://help.github.com/articles/fork-a-repo/)。
