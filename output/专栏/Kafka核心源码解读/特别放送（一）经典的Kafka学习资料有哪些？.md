...
Source: https://learn.lianglianglee.com/专栏/Kafka核心源码解读/特别放送（一）经典的Kafka学习资料有哪些？.md
...
1. Kafka的[Jira列表](https://issues.apache.org/jira/issues/?filter=-4&jql=project = KAFKA ORDER BY created DESC)，也就是我们俗称的Bug列表
...
1. YouTube上的[Kafka视频](https://www.youtube.com/results?search_query=apache+kafka&sp=EgIIAw%3D%3D)
