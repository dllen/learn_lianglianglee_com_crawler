...
Source: https://learn.lianglianglee.com/专栏/ElasticSearch知识体系详解/17 优化：ElasticSearch性能优化详解.md
...
如果是针对指定的 index 操作，可以通过 settings 设置 index.routing.allocation.require.box\_type: hot 将索引写入 hot 节点。
...
当索引不再被频繁查询时，可通过 index.routing.allocation.require.box\_type:warm，将索引标记为 warm，从而保证索引不写入 hot 节点，以便将 SSD 磁盘资源用在刀刃上。一旦设置这个属性，ES 会自动将索引合并到 warm 节点。
