...
Source: https://learn.lianglianglee.com/专栏/Kafka核心技术与实战/28 主题管理知多少_.md
...
说完了日常的主题管理操作，我们来聊聊Kafka内部主题**consumer\_offsets和**transaction\_state。前者你可能已经很熟悉了，后者是Kafka支持事务新引入的。如果在你的生产环境中，你看到很多带有**consumer\_offsets和**transaction\_state前缀的子目录，不用惊慌，这是正常的。这两个内部主题默认都有50个分区，因此，分区子目录会非常得多。
