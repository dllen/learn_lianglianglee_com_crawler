...
Source: https://learn.lianglianglee.com/专栏/前端工程化精讲-完/04  接口调试：Mock 工具如何快速进行接口调试？.md
...
**数据模板定义规范**约定了可以通过“属性名|生成规则：属性值”这样的格式来生成模拟数据，例如（完整示例代码参见 [04\_mock](https://github.com/fe-efficiency/lessons_fe_efficiency/tree/master/04_mock)）：
...
![image](assets/CgqCHl8_hQ6AR4HvAAWFAyE_iQ0413.png)
