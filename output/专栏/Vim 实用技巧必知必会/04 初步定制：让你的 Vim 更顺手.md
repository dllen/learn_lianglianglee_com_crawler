...
Source: https://learn.lianglianglee.com/专栏/Vim 实用技巧必知必会/04 初步定制：让你的 Vim 更顺手.md
...
![Fig4.1](assets/40016fac28fd6b3dd1361c4a9a39a07b.gif "浏览远程目录，打开一个 tar.gz 文件")

![Fig4.2](assets/f8675428065868331a7376a64f2143c2.gif "使用 Vim 查看 man 帮助")
...
![Fig4.3](assets/10885cf1c7406883c70838015971fb4c.png "插件安装之后的状态界面")
...
![Fig4.4](assets/2c44030349043755a98f9e237ae534d6.png "最近文件的菜单")
...
![Fig4.5](assets/f4435e4c42a7cf2be74f563e4f0b0fd8.gif "文本菜单的使用")
