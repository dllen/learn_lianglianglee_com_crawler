...
Source: https://learn.lianglianglee.com/专栏/Vim 实用技巧必知必会/15 插件荟萃：不可或缺的插件.md
...
![Fig15.1](assets/1d33862fae5ce87d891116770f254587.png ":Git log 命令的效果")
...
![Fig15.2](assets/a15e57500c55e5285da5c712f5076839.png ":0Gclog 命令的效果")

要查看文件的某一行是谁最后修改的，可以使用 `:Git blame` 命令。你不需要给出当前文件的名字，而且 Fugitive 会把输出放到一个跟当前文件编辑窗口联动的新窗口里，并进行了色彩加亮。

![Fig15.3](assets/67f1234d97b07e263b3f5yyyy75136a6.gif ":Git blame 命令的效果")

要比较当前文件和暂存区版本的区别，可以使用命令 `:Gvdiff`。

![Fig15.4](assets/9bb1805d2b287cba0a415788c80b3639.png ":Gvdiff 命令的效果")
...
![Fig15.5](assets/ee3479c8f61b666d7bea2077b9238f45.gif "在 :Git 命令后使用部分快捷键")
...
![Fig15.6](assets/bd438ca715cfdea46cf1869f80522bcc.png "默认配色方案下的 GitGutter 效果")

### 使用

下面的动图展示了 GitGutter 的核心功能（使用 gruvbox 配色方案）：

![Fig15.7](assets/6782e2ebd3216bb6d6681b620a9f0b87.gif "GitGutter 的功能展示")
...
![Fig15.8](assets/d71beed8a4e1e2b970c63f7317655yyc.png "启用了 Airline 的 Vim 界面")
...
![Fig15.9](assets/9a1afd2422ac186c6e835c0e6a545c5a.png "配置了显示缓冲区编号的 Vim 界面")
...
![Fig15.10](assets/503fb029feb4d00f511c5c270eccd4fd.gif "NERDCommenter 的多种不同注释类型")
...
![Fig15.11](assets/d8652f26606c4549e331c9b951faf079.gif "使用 Visual-Multi 来完成类型更名操作")
