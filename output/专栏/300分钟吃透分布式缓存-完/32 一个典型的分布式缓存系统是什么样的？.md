...
Source: https://learn.lianglianglee.com/专栏/300分钟吃透分布式缓存-完/32 一个典型的分布式缓存系统是什么样的？.md
...
由于本课程聚焦于缓存，接下来，我将以微博内的 分布式 Redis 服务系统为例，介绍一个典型的分布式缓存系统的组成。![img](assets/CgpOIF35zE2AKnujAAExXycRWQ4284.png)
