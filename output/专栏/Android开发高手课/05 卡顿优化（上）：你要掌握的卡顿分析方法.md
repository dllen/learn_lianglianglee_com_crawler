...
Source: https://learn.lianglianglee.com/专栏/Android开发高手课/05 卡顿优化（上）：你要掌握的卡顿分析方法.md
...
* 默认只支持主线程采集，其他线程需要[代码手动设置](https://github.com/uber/nanoscope/wiki/Architecture:-Nanoscope-ROM#java-api)。考虑到内存大小的限制，每个线程的内存数组只能支持大约20秒左右的时间段。
